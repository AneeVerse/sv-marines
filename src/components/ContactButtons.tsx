  ...
  return (
    <div className={`fixed right-0 bottom-10 z-50 ${isOpen ? 'opacity-100' : 'opacity-70 hover:opacity-100'} transition-opacity duration-300`}>
      <div className="py-4 px-2 flex flex-col items-center space-y-4">
        {isOpen && (
          <>
            ...
            <button 
              ...
              aria-label="Phone"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="#34B7F1">
        ...
        <button 
          onClick={toggleOpen} 
          className={`w-12 h-12 bg-[#F55B1F] rounded-full flex items-center justify-center text-white ${isOpen ? 'rotate-45' : 'rotate-0'} transition-transform shadow-md`}
