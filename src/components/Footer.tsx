              ...
              <div className="w-full md:w-1/3">
                <div className="relative w-full max-w-md mx-auto md:ml-auto md:mr-0">
                  ...
                  <button className="
                    ...
                    hover:bg-white
                    border-2 border-[#001529]
                    hover:text-[#001529]
                    hover:border-2 hover:border-[#001529]
                    hover:shadow-lg
                    group
                  ">
                    <span className="hidden sm:inline">Connect Now</span>
                    <span className="sm:hidden">Connect</span>
                    <div className="ml-1 md:ml-2 bg-white group-hover:bg-[#001529] rounded-full w-5 h-5 md:w-6 md:h-6 flex items-center justify-center transition-colors duration-300">
